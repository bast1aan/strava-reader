...
class Activity:
	...
	recovery: bool # 'Herstel',
	with_pet: bool # 'Met huisdier',
	is_race: bool # 'Wedstrijd',
	is_long_run: bool # 'Lange loop',
	is_for_a_purpose: bool # 'Voor een doel',
	with_child: bool # 'Met kind',
	distance_descending: float # 'Afstand bergaf',
	total_sets: int # 'Totaal aantal sets',
	total_retries: int # 'Totaal aantal herhalingen',
	media: str # 'Media',
