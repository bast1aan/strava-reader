...
from typing import Sequence, Protocol, Literal, Mapping
...
class SummaryPRSegmentEffort(Protocol):
	effort_count: int | None
	"""
	Number of efforts by the authenticated athlete on this segment.
	"""
	pr_activity_id: int | None
	"""
...
class SummarySegment(Protocol):
	activity_type: Literal["Ride", "Run"] | None
	athlete_pr_effort: SummaryPRSegmentEffort | None
	athlete_segment_stats: SummarySegmentEffort | None
...
class SummarySegmentEffort(Protocol):
...
class DetailedActivity(SummaryActivity):
	best_efforts: Sequence[DetailedSegmentEffort] | None
	calories: float | None
	"""
	...
	segment_efforts: Sequence[DetailedSegmentEffort] | None
